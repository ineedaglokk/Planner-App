...
// MARK: - IncomeEntry Model

@Model
final class IncomeEntry: CloudKitSyncable, Timestampable, Identifiable {
    
    // MARK: - Properties
    
    @Attribute(.unique) var id: UUID
    var name: String // Название поступления
...
// MARK: - IncomeEntry Extensions

extension IncomeEntry: Validatable {
